    ...
    <div className="bg-black text-white min-h-screen">
        ...
        <motion.div
          ...
          <div className="md:w-1/2">
            <p className="text-lg leading-relaxed text-gray-300">
              At Porsche, we strive to innovate and deliver exceptional performance
              that exceeds expectations. Our mission is to push the boundaries of
              luxury, speed, and engineering excellence.
            </p>
          </div>
        </motion.div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {[1, 2].map((item, index) => (
            <motion.div
              ...
              transition={{ duration: 1, delay: 0.3 }}>
              <h3 className="text-2xl font-bold mb-2">Milestone {index + 1}</h3>
              <p className="text-gray-400">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer
                eget commodo dolor. Duis dapibus risus ut nisl sollicitudin
                gravida.
              </p>
            </motion.div>
          ))}
      ...
      <section className="py-16 px-8 text-center">
        ...
        <motion.p
          ...
          animate={{ opacity: 1 }}
          transition={{ duration: 1, delay: 0.3 }}>
          Have questions or want to learn more about Porsche? Contact us today!
        </motion.p>
        <motion.button
